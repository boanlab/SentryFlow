...
import sentryflow_metrics_pb2 as sentryflow__metrics__pb2
...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in sentryflow_metrics_pb2_grpc.py depends on'
...
class APIClassifier(object):
    ...
    @staticmethod
    def ClassifyAPIs(request_iterator,
            target,
            options=(),
